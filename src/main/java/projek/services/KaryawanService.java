...
import projek.GUI.panel.KaryawanPanel;
...
public class KaryawanService {
        ...
        try {
            for (Karyawan k : daftarKaryawan) {
                ...
                tombolEdit.addActionListener((ActionEvent e) -> {
                    // Signal the KaryawanPanel instance to populate its form
     ...
     * @param idK
     */
    public void hapusKaryawan(String uidOrId) {
        // Try by uidRfid first, fallback to idKaryawan
        Bson filter = Filters.or(
            Filters.eq("uidRfid", uidOrId),
            Filters.eq("idKaryawan", uidOrId)
        );
